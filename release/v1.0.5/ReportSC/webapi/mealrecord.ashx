...
public class Handler : IHttpHandler
{
    ...
    mealrecord mealrecordBLL = new mealrecord();
    ...
    private string Upload(HttpContext context)
    {
        ...
        return mealrecordBLL.doSync(json);
    }
    ...
    private string GetList(HttpContext context)
    {
        ...
        string orderBy = " MealRecord_DBKey desc";
        string str = JsonConvert.SerializeObject(mealrecordBLL.GetModelList(strWhere, limit, orderBy), Global.GetJsonFormatting(context), Global.jsonSerializerSettings);
        return str;
    }
    ...
    private string GetListCount(HttpContext context)
    {
        ...
        string strWhere = " b.InHospitalData >= '" + sdate + "' and b.InHospitalData <= '" + edate + "' ";
        string str = mealrecordBLL.GetListCount(strWhere);
        return str;
    }
