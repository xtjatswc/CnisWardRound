...
public class Handler : IHttpHandler
{
    ...
    private string GetList(HttpContext context)
    {
        ...
        string str = JsonConvert.SerializeObject(bodyanalysisreportBLL.GetList(strWhere, limit), Global.GetJsonFormatting(context), Global.jsonSerializerSettings);
        return str;
    }
    ...
    private string GetListCount(HttpContext context)
    {
        ...
        string strWhere = " b.InHospitalData >= '" + sdate + "' and b.InHospitalData <= '" + edate + "' ";
        string str = bodyanalysisreportBLL.GetListCount(strWhere);
        return str;
    }
