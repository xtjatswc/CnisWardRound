...
public class Handler : IHttpHandler {
    ...
    optiondetail optiondetailBLL = new optiondetail();
    ...
    private string GetList(HttpContext context)
    {
        ...
        string orderBy = " QuestionOption_DBKey desc";
        string str = JsonConvert.SerializeObject(optiondetailBLL.GetModelList(strWhere, limit, orderBy), Global.GetJsonFormatting(context), Global.jsonSerializerSettings);
        return str;
    }

    private string GetListCount(HttpContext context)
    {
        string str = optiondetailBLL.GetListCount();
        return str;
    }
