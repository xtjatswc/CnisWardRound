...
public class Handler : IHttpHandler {
    ...
    courserecord courserecordBLL = new courserecord();
    ...
    private string Upload(HttpContext context)
    {
        ...
        return courserecordBLL.doSync(json);        
    }
    ...
    private string GetList(HttpContext context)
    {
        ...
        string orderBy = " CourseRecord_DBKey desc";
        string str = JsonConvert.SerializeObject(courserecordBLL.GetModelList(strWhere, limit, orderBy), Global.GetJsonFormatting(context), Global.jsonSerializerSettings);
        return str;
    }
    ...
    private string GetListCount(HttpContext context)
    {
        ...
        string strWhere = " b.InHospitalData >= '" + sdate + "' and b.InHospitalData <= '" + edate + "' ";
        string str = courserecordBLL.GetListCount(strWhere);
        return str;
    }
