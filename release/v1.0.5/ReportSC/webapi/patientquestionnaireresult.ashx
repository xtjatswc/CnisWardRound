...
public class Handler : IHttpHandler {
    ...
    patientquestionnaireresult patientquestionnaireresultBLL = new patientquestionnaireresult();
    ...
    private string Upload(HttpContext context)
    {
        ...
        return patientquestionnaireresultBLL.doSync(json);
    }
    ...
    private string GetList(HttpContext context)
    {
        ...
        string orderBy = " PatientQuestionnaireResult_DBKey desc";
        string str = JsonConvert.SerializeObject(patientquestionnaireresultBLL.GetModelList(strWhere, limit, orderBy), Global.GetJsonFormatting(context), Global.jsonSerializerSettings);
        return str;
    }
    ...
    private string GetListCount(HttpContext context)
    {
        ...
        string str = patientquestionnaireresultBLL.GetListCount(strWhere);
        return str;
    }
