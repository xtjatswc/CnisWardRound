...
public class Handler : IHttpHandler
{
    ...
    relationofdietaryfood relationofdietaryfoodBLL = new relationofdietaryfood();
    ...
    private string Upload(HttpContext context)
    {
        ...
        return relationofdietaryfoodBLL.doSync(json);
    }
    ...
    private string GetList(HttpContext context)
    {
        ...
        string strWhere = " c.InHospitalData >= '" + sdate + "' and c.InHospitalData <= '" + edate + "' ";
        string limit = context.Request.QueryString["limitStart"] + "," + context.Request.QueryString["limitSize"];
        string orderBy = " RelationOfDietaryFood_DBKey desc";
        string str = JsonConvert.SerializeObject(relationofdietaryfoodBLL.GetModelList(strWhere, limit, orderBy), Global.GetJsonFormatting(context), Global.jsonSerializerSettings);
        return str;
    }
    ...
    private string GetListCount(HttpContext context)
    {
        ...
        string strWhere = " c.InHospitalData >= '" + sdate + "' and c.InHospitalData <= '" + edate + "' ";
        string str = relationofdietaryfoodBLL.GetListCount(strWhere);
        return str;
    }
