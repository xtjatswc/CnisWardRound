...
public class Handler : IHttpHandler {
    ...
    syscode syscodeBLL = new syscode();
    ...
    private string GetList(HttpContext context)
    {
        ...
        string orderBy = " SystemCode_DBKEY desc";
        string str = JsonConvert.SerializeObject(syscodeBLL.GetModelList(strWhere, limit, orderBy), Global.GetJsonFormatting(context), Global.jsonSerializerSettings);
        return str;
    }

    private string GetListCount(HttpContext context)
    {
        string str = syscodeBLL.GetListCount();
        return str;
    }
