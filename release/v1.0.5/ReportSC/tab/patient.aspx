...
<body>
    <form runat="server">
        <br />
        <font color="red"> - 按患者姓名查询：</font>
        <asp:TextBox runat="server" ID="txtPatientName"></asp:TextBox>
        &nbsp;&nbsp;       
                                    ...
                                    <td width="46%" valign="middle">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                ...
                                                <td width="95%" class="STYLE1"><span class="STYLE3"><%=txtPatientName.Text %>&nbsp;&nbsp;共缴费：<%=totalMoney %></span></td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td width="54%">
                        ...
                        <td>
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()" onmouseout="changeback()">
                                <tr>
                                    ...
                                    <td height="22" background="images/bg.gif" bgcolor="#FFFFFF">
                                        <div align="center"><span class="STYLE1">缴费日期</span></div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    %>
                                                                        ...
                                                                        <%
                                        //缴费日期
                                        if (chargeDate != saleModel.ChargeDate)
                                        {
                                            chargeDate = saleModel.ChargeDate;
                                    %>
                                    <td height="20" bgcolor="#FFFFFF" rowspan="<%=listSaleModel.Count(o=>o.ChargeDate == chargeDate) %>">
                                        <div align="center"><span class="STYLE1"><%=saleModel.ChargeDate %></span></div>
                                    </td>
                                    <%
                                        }
                                    %>
