          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">按科室统计销售量</span></td>
              </tr>
            </table></td>
      ...
      <tr>
        ...
        <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
            ...
            <td width="12%" height="22" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">科室名称</span></div></td>
            <td width="14%" height="22" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">销售总额</span></div></td>
            <td width="14%" height="22" background="images/bg.gif" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1">进货总额</span></div></td>
          </tr>
            <asp:Repeater runat="server" ID="rptProductSale">
                <ItemTemplate>
          <tr>
            <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE1">
              <div align="center"><%#Eval("rowno") %></div>
            </div></td>
            ...
            <td height="20" bgcolor="#FFFFFF"><div align="center"><span class="STYLE1"><%#Eval("SupplyMoney") %> </span></div></td>
          </tr>
    ...
    <td height="35" background="images/tab_19.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="16"><img src="images/tab_20.gif" width="16" height="35" /></td>
            ...
            <div id="chartdiv" align=""> FusionCharts. </div>
                    </td>
        ...
        <script type="text/javascript">
            var chart = new FusionCharts("../Charts/Column3D.swf", "ChartId", "700", "400", "0", "0");
            //chart.setXMLUrl("../Data/XML/Col3D2.xml");
            chart.setXMLUrl("../AjaxServer/department.ashx?opt=GetDepartmentSaleXmlData&beginDate=<%=txtBeginDate.Value %>&endDate=<%=txtEndDate.Value %>");
