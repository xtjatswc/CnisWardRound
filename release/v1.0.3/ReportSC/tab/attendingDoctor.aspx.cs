...
public partial class attendingDoctor : System.Web.UI.Page
{
    ...
    {
        DataTable dt = departmentSaleBLL.GetAttendingDoctorSale(DateTime.Parse(txtBeginDate.Value), DateTime.Parse(txtEndDate.Value));
